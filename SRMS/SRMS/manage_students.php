                ...
                while($row = mysqli_fetch_array($result))
                  {
                    ...
                    echo "<td>";  ?><a href="delete_student.php?rno=<?php echo  $row['rno']; ?> <button type="button" class="btn btn-danger">delete</button></a>  <?php echo "</td>";
                    echo "<td>";  ?><a href="update_student.php?rno=<?php echo  $row['rno']; ?> <button type="button" class="btn btn-primary">update</button></a>  <?php echo "</td>";
                    echo "</tr>";
                  }
